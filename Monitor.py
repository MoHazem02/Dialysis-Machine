...
"border-radius: 8px;")
        ...
        self.Conductivity = QtWidgets.QLCDNumber(self.groupBox_2)
        self.Conductivity.setGeometry(QtCore.QRect(220, 60, 141, 101))
        ...
        self.label_10.setGeometry(QtCore.QRect(240, 30, 141, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
